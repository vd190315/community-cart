...
export function PublicLanding() {
  ...
  return (
    <article className="relative left-1/2 flex w-screen -translate-x-1/2 flex-col overflow-x-hidden pb-12 sm:pb-16">
      ...
      <header className="relative order-1 z-0 overflow-hidden border-b border-emerald-100/90 bg-brand-50">
        <div
          ...
          aria-hidden
        />
        <div className="relative z-10 mx-auto max-w-lg px-4 pb-10 pt-8 sm:max-w-2xl sm:px-6 sm:pb-12 sm:pt-10 lg:max-w-5xl lg:pb-16 lg:pt-12">
          <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:gap-14">
            <div className="flex min-w-0 flex-col gap-5">
              ...
              <div className="space-y-2 text-[1.0625rem] leading-snug text-slate-600 sm:text-lg sm:leading-relaxed lg:max-w-xl">
            ...
            <div className="landing-gentle-float flex min-w-0 justify-center lg:justify-end">
              <div className="w-full max-w-[20.5rem] rounded-[1.65rem] border border-emerald-100/90 bg-white p-4 shadow-sm ring-1 ring-slate-900/[0.03] sm:max-w-md sm:p-6 lg:max-w-none">
      ...
      <section
        id="waitlist"
        className="relative order-2 z-0 border-b border-emerald-100/80 bg-white/82 backdrop-blur-[2px] lg:order-4 lg:border-b-0 lg:bg-white/78"
        aria-labelledby="waitlist-heading"
      >
        <div className="mx-auto max-w-lg px-4 py-12 sm:max-w-2xl sm:px-6 sm:py-14 lg:max-w-5xl lg:py-16">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,300px)] lg:items-start lg:gap-12">
            <div>
              <h2
                id="waitlist-heading"
      ...
      <section
        className="relative order-3 z-0 bg-white/65 backdrop-blur-[1px] lg:order-2"
        aria-labelledby="loop-heading"
      >
        <div className="mx-auto max-w-lg px-4 py-12 sm:max-w-2xl sm:px-6 sm:py-16 lg:max-w-5xl">
          <h2
            id="loop-heading"
          ...
          <div className="relative mt-12 max-w-3xl sm:mt-14 lg:max-w-none">
            <span
            ...
            <ol className="relative m-0 list-none p-0">
              ...
              <li className="relative flex gap-4 pb-11 sm:gap-5 sm:pb-14">
                ...
                <div className="min-w-0 flex-1 sm:ml-4 sm:max-w-xl lg:ml-8">
      ...
      {/* 4 · Why */}
      <section
        className="relative order-4 z-0 border-y border-emerald-100/80 bg-brand-50/45 backdrop-blur-[1px] lg:order-3"
        aria-labelledby="why-heading"
      >
        <div className="mx-auto max-w-lg px-4 py-12 sm:max-w-2xl sm:px-6 sm:py-14 lg:max-w-5xl">
          ...
          <div className="mt-8 space-y-6 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-6 lg:gap-8">
      ...
      <footer className="relative order-5 z-0 border-t border-emerald-100/80 bg-white/88 backdrop-blur-[1px] lg:order-5">
        <div className="mx-auto flex max-w-lg flex-col items-center justify-between gap-4 px-4 py-8 text-center text-[13px] text-slate-500 sm:max-w-2xl sm:flex-row sm:px-6 sm:text-left lg:max-w-5xl">
